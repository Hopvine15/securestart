...
fn initial_modules() -> Vec<TrainingModule> {
    vec![
        TrainingModule {
            ...
            content: "AI can help attackers create believable phishing emails, messages and fake websites. Pause before acting on urgent requests, check the sender and links independently, and report anything suspicious.".to_string(),
        },
        TrainingModule {
            ...
            content: "Treat AI-generated code as a draft, not trusted source code. Check authentication, input validation, secrets handling and dependencies before committing. Test the code and use your team's review process.".to_string(),
        },
        TrainingModule {
            ...
            content: "Do not paste passwords, API keys, customer records or confidential business information into AI tools unless your organisation has approved that use. Remove identifying details and follow your data-handling policy.".to_string(),
        },
        TrainingModule {
            ...
            content: "Use a password manager to create unique passwords, enable multi-factor authentication and never share verification codes. Report unexpected sign-in prompts and change a password immediately if you suspect compromise.".to_string(),
        },
    ]
}
